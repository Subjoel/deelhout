<div class="product-item">
    ...
    <div class="row-custom item-details">
        ...
        if (date_create(date('m/d/Y', strtotime($product->created_at))) < date_create(date('m/d/Y', strtotime("-1 months"))) && date_create(date('m/d/Y H:i:s', strtotime($product->created_at))) > date_create(date('m/d/Y H:i:s', strtotime("3 months ago")))): ?>
        <a href="<?= generateProductUrl($product); ?>"><?= getProductTitle($product); ?> 🟡</a>
        <?php elseif (date_create(date('m/d/Y', strtotime($product->created_at))) < date_create(date('m/d/Y', strtotime("3 months ago"))) ): ?>
        <a href="<?= generateProductUrl($product); ?>"><?= getProductTitle($product); ?> 🔴</a>
        <?php else: ?>
        <a href="<?= generateProductUrl($product); ?>"><?= getProductTitle($product); ?> 🟢</a>
        <?php endif; ?>
