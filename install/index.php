                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    ...
                                                    <br><br>
                                                    If you see the "Invalid License Code" error, please read this article:&nbsp;<a href="#" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="#" target="_blank" class="btn btn-success btn-custom">NULLED by Marcus8</a>
                                            </div>
                                            <div class="form-group text-center">
                                                <strong style="font-size: 600;"><a href="#" target="_blank">Watch the installation video</a></strong>
                                            </div>
                                            <div class="form-group">
